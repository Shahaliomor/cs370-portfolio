...
class TreasureMaze(object):
    ...
    def update_state(self, action):
        nrows, ncols = self.maze.shape
        # --- FIX 1: correct unpack / initialization ---
        ...
        if not valid_actions:
            ...
            # --- FIX 2: set nmode (not mode) on invalid ---
            nmode = 'invalid'  # invalid action, no change in pirate position
    ...
    def get_reward(self):
        ...
        # --- FIX 3: ensure invalid gets stronger penalty than "visited" ---
        if mode == 'invalid':
            return -0.75
